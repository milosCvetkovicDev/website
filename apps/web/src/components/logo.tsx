 ...
 * header of every page has none. Under reduced motion it does not blink at all.
 *
...
export function Logo({ className = '', size = 20 }: { className?: string; size?: number }) {
  return (
    ...
    >
      mc
      <span className="ml-[0.04em] inline-block h-[0.1em] w-[0.55em] translate-y-[0.12em] bg-[var(--accent)] motion-safe:animate-[mc-blink_1.2s_steps(1)_4]" />
    </span>
  );
}
