    ...
    <div className="py-16 md:py-24">
      <div className="mx-auto max-w-3xl px-6">
        ...
        <p className="mb-12 text-xl text-[var(--muted)]">
          ...
          your preferred platform and say hi.
        </p>
            ...
            {socialLinks.map((link) => (
              ...
              >
                ...
                <div className="flex-1">
                  <h2 className="mb-1 text-lg font-semibold">{link.name}</h2>
                  <p className="text-sm text-[var(--muted)]">{link.description}</p>
                </div>
                <span
                  className={`hidden items-center gap-2 rounded-lg px-4 py-2 text-sm font-medium transition-colors sm:inline-flex ${
                    link.primary
        ...
        <section className="rounded-2xl border border-[var(--border)] bg-[var(--card)] p-8 text-center">
          <p className="mb-4 text-lg">Want to see what I&apos;ve been working on?</p>
