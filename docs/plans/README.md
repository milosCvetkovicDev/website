...
| [2026-09-09-home-page-performance-plan.md](2026-09-09-home-page-performance-plan.md)             | Plan   | Shipped | Merged in PR #15. Home page CLS and TBT: shift-free tmux log slots, compositor-only keyframes, story sections mounted on approach, FeaturedWork out of the layout chunk. Carries its own rationale; the standing rules are [ADR 0009](../adr/0009-animation-performance-rules.md).                                                                                                                                                                                                                                                                                                                                                                                  |
