...
| [2026-09-10-local-playwright-port-design.md](2026-09-10-local-playwright-port-design.md)         | Design | In review | Why local Playwright runs stopped using port 3000 and stopped reusing a running server. Decisions D1-D6; the standing record is [ADR 0014](../adr/0014-playwright-owns-its-server.md). Branch `chore/local-playwright-port`.                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| [2026-09-10-local-playwright-port-plan.md](2026-09-10-local-playwright-port-plan.md)             | Plan   | In review | The five tasks deriving from that design: the resolved port and owned server, the `.next-e2e` build directory, the three reworded title guards, the documentation, and verification against a foreign `next start` on 3000. Branch `chore/local-playwright-port`.                                                                                                                                                                                                                                                                                                                                                                                                   |
