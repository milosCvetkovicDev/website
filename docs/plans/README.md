...
| [2026-09-08-featured-work-plan.md](2026-09-08-featured-work-plan.md)                             | Plan   | In review | PR #4, branch `feat/featured-work-architecture-diagram`. The file is not on this branch yet, so the link resolves only once that branch is merged.                                                                          |
