...
| [2026-09-08-repo-hardening-and-launch-design.md](2026-09-08-repo-hardening-and-launch-design.md) | Design | In progress | The current effort: quality gates, CI, the Featured Work feature, documentation and the launch. Decisions D1 to D8 shipped in PR #3, D9 in PR #4, D10 and D11 in PR #5. The site is still not deployed.                                                                                                                                                                                                                                                                                                                                |
...
| [2026-09-08-docs-and-deployment-plan.md](2026-09-08-docs-and-deployment-plan.md)                 | Plan   | In review   | PR #5, branch `docs/readme-adrs-and-deploy`. The root README, the six ADRs, the deployment runbook, this index and the rewritten project instructions.                                                                                                                                                                                                                                                                                                                                                                                 |
| [2026-09-09-home-page-performance-plan.md](2026-09-09-home-page-performance-plan.md)             | Plan   | In review   | Branch `perf/home-page-cls-and-tbt`. Home page CLS and TBT: shift-free tmux log slots, compositor-only keyframes, story sections mounted on approach, FeaturedWork out of the layout chunk. Carries its own rationale; the standing rules are ADR 0009.                                                                                                                                                                                                                                                                                |
